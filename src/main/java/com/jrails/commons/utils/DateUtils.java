...
public class DateUtils {
    ...
    public static String getTime(Calendar calendar) {
        return DateFormatUtils.format(calendar, "HH:mm");
    }

    public static String getDayTime(Calendar calendar) {
        return DateFormatUtils.format(calendar, "ddHHmm");
    }
    ...
    public static String getDate2() {
        return getDate2(Calendar.getInstance());
    }

    public static String getDate2(Calendar calendar) {
        return DateFormatUtils.format(calendar, "HH:mm MM-dd");
    }
