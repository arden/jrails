...
import com.jrails.commons.utils.WebUtils;
 ...
 * high performance.
 * @author Greg Luck
 * @version $Id: SimplePageCachingFilter.java 595 2008-03-19 10:23:46Z gregluck $
 */
public class SimplePageCachingFilter extends CachingFilter {
    ...
    protected String calculateKey(HttpServletRequest httpRequest) {
        ...
        String queryString = StringUtils.nullStringToEmptyString(httpRequest.getQueryString());
        Map<String, String> params = WebUtils.parseQueryString(queryString);
        if (params != null && !params.isEmpty()) {
            ...
            queryString = WebUtils.buildQueryParams(params, "&");
        }
        if (!StringUtils.isEmpty(queryString)) {
            stringBuffer.append(httpRequest.getMethod()).append(uri).append("?").append(queryString);
        } else {
            stringBuffer.append(httpRequest.getMethod()).append(uri);
        }
