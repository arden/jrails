...
package com.jrails.modules.cache.ehcache.web.filter;
...
import com.jrails.modules.cache.ehcache.web.AlreadyCommittedException;
import com.jrails.modules.cache.ehcache.web.AlreadyGzippedException;
import com.jrails.modules.cache.ehcache.web.GenericResponseWrapper;
import com.jrails.modules.cache.ehcache.web.PageInfo;
import com.jrails.modules.cache.ehcache.web.ResponseHeadersNotModifiableException;
import com.jrails.modules.cache.ehcache.web.ResponseUtil;
import com.jrails.modules.cache.ehcache.web.SerializableCookie;
    ...
    protected PageInfo buildPageInfo(final HttpServletRequest request, final HttpServletResponse response,
        ...
        try {
            ...
            if (element == null || element.getObjectValue() == null) {
                try {
                    // Page is not cached - build the response, cache it, and send to local
                    ...
                    if (pageInfo.isOk()) {
                        ...
                        if (LOG.isWarnEnabled()) {
                            LOG.warn("PageInfo was not ok(200). Should be putting null into cache, but there ingore put to cache " + blockingCache.getName()
                                    + " with key " + key);
                        }
